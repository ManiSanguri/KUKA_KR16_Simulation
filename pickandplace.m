function [end_test,place_pos,above_place_pos,above_pickup_pos]=pickandplace(origine_table,length_nbre,width_nbre,hight_nbre,cube_dimension,width_offset,length_offset,place_pos,above_place_pos,above_pickup_pos)
