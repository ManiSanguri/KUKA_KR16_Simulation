...
for i=1:samples_number
    ...
    % set the intermidiate position
    vrep.simxSetObjectPosition(clientID,target,-1,intermidiate_pos,vrep.simx_opmode_blocking);
    vrep.simxSetObjectPosition(clientID,target,-1,intermidiate_pos(4:6),vrep.simx_opmode_blocking);
